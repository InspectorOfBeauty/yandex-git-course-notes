...
В этот момент файл находится в состоянии staged. <br>


Раньше мы сравнивали коммит с фотографией. Можно усовершенствовать аналогии. Представлять теперь, что **git add добавляет персонажей (текущее содержимое файлов) на сцену для общей фотографии. А git commit делает снимок всей сцены целиком.** <br>
